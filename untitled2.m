...
rate5 = [5.06 4.32 1.00 2.48 1.49]; % Rock creek incubation
TOCPercentage5 = [1.7 1.8 2.0 0.9 0.8];
...
plot(TOCPercentage,rate4,'>','MarkerSize',8);
plot(TOCPercentage5,rate5,'<','MarkerSize',8);
set(gca,'fontsize',18);
set(gca, 'FontName', 'Times New Roman');
set(gca,'XColor','k');
set(gca,'YColor','k');
...
legend('BCT Low resolution','BCT High resolution','BM (reported)','BCT second rewetting','Rock Creek');